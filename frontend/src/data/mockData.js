...
export const INITIAL_WORKS = [
    // 5 TRABAJOS PENDIENTES (Por Revisar)
    {
        id: "TRB-101",
        title: "Uso de IA en diagnóstico precoz de ACV",
        ...
        abstract: { introduction: "...", objective: "...", methodology: "...", results: "...", conclusions: "..." },
        scores: []
    },
    {
        id: "TRB-102",
        title: "Telemedicina en neurología para zonas rurales",
    ...
    {
        id: "TRB-103",
        title: "Impacto del COVID-19 prolongado en la salud mental",
    ...
    {
        id: "TRB-104",
        title: "Nuevas terapias biológicas para el Alzheimer",
    ...
    {
        id: "TRB-105",
        title: "Resistencia antibiótica en neurocirugía de UCI",
    ...
    // 5 TRABAJOS ACEPTADOS
    {
        id: "TRB-201",
        title: "Avances en la cirugía reconstructiva de base de cráneo",
        ...
        submittedAt: "2025-11-01T10:00:00",
        abstract: { introduction: "...", objective: "...", methodology: "...", results: "...", conclusions: "..." },
        scores: [4.5, 4.8]
    },
    {
        id: "TRB-202",
        title: "Epilepsia Refractaria: Abordaje quirúrgico multidisciplinario",
    ...
    {
        id: "TRB-203",
        title: "Microcirugía Vascular Cerebral de alta complejidad",
        ...
        day: "Miércoles 24",
        room: "Sala B",
        submittedAt: "2025-11-10T09:15:00",
        abstract: { introduction: "...", objective: "...", methodology: "...", results: "...", conclusions: "..." },
        scores: [4.9, 5.0]
    },
    {
        id: "TRB-204",
        title: "Trastornos del Sueño y Calidad de Vida en la Tercera Edad",
        ...
        day: "Jueves 25",
        room: "Sala Virtual 1",
        submittedAt: "2025-11-12T16:45:00",
        abstract: { introduction: "...", objective: "...", methodology: "...", results: "...", conclusions: "..." },
        scores: [4.0, 3.8]
    },
    {
        id: "TRB-205",
        title: "Protocolo de Neurorehabilitación Post-ACV Isquémico",
        author: "Dr. Carlos Gomez",
        authorId: "user-3",
        type: "Trabajo Original",
        specialty: "Medicina Física",
        status: "Aceptado",
        day: "Viernes 26",
        room: "Sala C",
        submittedAt: "2025-11-15T11:20:00",
        abstract: { introduction: "...", objective: "...", methodology: "...", results: "...", conclusions: "..." },
        scores: [4.6, 4.7]
    },

    // 5 TRABAJOS OBSERVADOS
    {
        id: "TRB-301",
        title: "Estudio descriptivo de cefaleas tensionales en Lima",
        author: "Dra. Maria Lopez",
        authorId: "user-25",
        type: "Trabajo Original",
        specialty: "Neurología",
        status: "Observado",
        observation: "Falta definir criterios de inclusión y mejorar la metodología.",
        submittedAt: "2025-11-20T08:00:00",
        abstract: { introduction: "...", objective: "...", methodology: "...", results: "...", conclusions: "..." },
        scores: []
    },
    {
        id: "TRB-302",
        title: "Prevalencia de Parkinson en adultos mayores de la costa",
        author: "Dra. Ana Torres",
        authorId: "user-24",
        type: "Trabajo Original",
        specialty: "Neurología",
        status: "Observado",
        observation: "Debe corregir el formato de las citas bibliográficas.",
        submittedAt: "2025-11-21T10:30:00",
        abstract: { introduction: "...", objective: "...", methodology: "...", results: "...", conclusions: "..." },
        scores: []
    },
    {
        id: "TRB-303",
        title: "Manejo de TEC leve: Guía de práctica clínica",
        author: "Dr. Carlos Ruiz",
        authorId: "user-23",
        type: "Revisión Sistemática",
        specialty: "Neurocirugía",
        status: "Observado",
        observation: "Incluir referencias de los últimos 2 años.",
        submittedAt: "2025-11-22T13:45:00",
        abstract: { introduction: "...", objective: "...", methodology: "...", results: "...", conclusions: "..." },
        scores: []
    },
    {
        id: "TRB-304",
        title: "Factores de riesgo genéticos en ACV isquémico",
        author: "Dr. Luis Fernández",
        authorId: "user-22",
        type: "Trabajo Original",
        specialty: "Neurología",
        status: "Observado",
        observation: "Tamaño de muestra insuficiente para las conclusiones presentadas.",
        submittedAt: "2025-11-23T15:00:00",
        abstract: { introduction: "...", objective: "...", methodology: "...", results: "...", conclusions: "..." },
        scores: []
    },
    {
        id: "TRB-305",
        title: "Nuevos fármacos para el tratamiento del dolor neuropático",
        author: "Dr. Roberto Sánchez",
        authorId: "user-21",
        type: "Reporte de Caso",
        specialty: "Neurología",
        status: "Observado",
        observation: "Clarificar la metodología utilizada en el reporte.",
        submittedAt: "2025-11-24T17:20:00",
        abstract: { introduction: "...", objective: "...", methodology: "...", results: "...", conclusions: "..." },
        scores: []
    }
];
